...
let GetData = async () => {
    ...
    return elements.push(`<div class="w-1/4 h-56 bg-white shadow-md bg-gray-50 rounded-xl ml-20 mt-12 relative">
    ...
    <p class="text-2xl ml-8  font-bold text-gray-400">${e.Horários.slice(0,2) + ":" + e.Horários.slice(2,4)}</p>
