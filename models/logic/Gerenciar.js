...
let GetAlunos = async () => {
    ...
    await data.forEach(e => {
        return AlunosRender.push(`<tr class="bg-gray-100">
  ...
  <path d="M13.586 3.586a2 2 0 112.828 2.828l-.793.793-2.828-2.828.793-.793zM11.379 5.793L3 14.172V17h2.828l8.38-8.379-2.83-2.828z" />
                        ...
                        <button class="delete m-4" data-id="${e.id}">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-gray-900" viewBox="0 0 20 20" fill="currentColor">
...
let GetProfessores = async () => {
    ...
    await data.forEach(e => {
        return ProfessoresRender.push(`<tr class="bg-gray-100">
                        <td class="text-center text-gray-900 font-bold" id="id">${e.id}</td>
                        <td class="text-center text-gray-800" id="nome">${e.Nome}</td>
                        <td class="text-center text-gray-800" id="email">${e.Email}</td>
                        <td class="text-center text-gray-800" id="datadenascimento">${e.DataDeNascimento.slice(0,10)}</td>
                        ...
                        <td>
                        <div class="flex justify-center items-center">
                        <a class="m-4" href="atualizarProfessor/${e.id}">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-gray-900" viewBox="0 0 20 20" fill="currentColor">
  <path d="M13.586 3.586a2 2 0 112.828 2.828l-.793.793-2.828-2.828.793-.793zM11.379 5.793L3 14.172V17h2.828l8.38-8.379-2.83-2.828z" />
</svg></a>
                        <button class="delete m-4" data-id="${e.id}">
