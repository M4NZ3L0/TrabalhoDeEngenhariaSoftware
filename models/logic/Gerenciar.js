...
let GetInstrumentos = async () => {
    ...
    await data.forEach(e => {
        return InstrumentosRender.push(`<tr>
    <td id="id">${e.id}</td>
                        <td id="nome">${e.Nome}</td>
                        <td id="imagem">${e.Imagem}</td>
                        <td id="codigo">${e.Código}</td>
                        <td id="tipo">${e.Tipo}</td>
                        <td id="tamanhocms">${e.TamanhoCms}</td>
                        <td id="pesokgs">${e.PesoKgs}</td>
                    </tr>`)
    });
};
